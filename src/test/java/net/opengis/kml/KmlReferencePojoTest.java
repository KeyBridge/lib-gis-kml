...
public final class KmlReferencePojoTest implements IKMLReference {
  ...
  public void ballonStyleExample() {
    ...
    final List<Coordinate> coord = new ArrayList<>();
  ...
  public void documentExample() {
    ...
    List<Coordinate> coord1 = new ArrayList<>();
  ...
  public void folderExample() {
    ...
    List<Coordinate> coord3 = new ArrayList<>();
  ...
  public void networkLinkControl() {
    ...
    networklinkcontrol.setUpdate(new Update("", new ArrayList<>()));
  ...
  public void updateChange() {
    ...
    final Update update = new Update("http://www/~sam/January14Data/Point.kml", new ArrayList<>());
  ...
  public void updateCreate() {
    final Update update = new Update("http://myserver.com/Point.kml", new ArrayList<>());
  ...
  public void updateDelete() {
    final Update update = new Update("http://www.foo.com/Point.kml", new ArrayList<>());
