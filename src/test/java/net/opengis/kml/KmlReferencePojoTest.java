...
import net.opengis.kml.internal.IKMLReference;
...
import net.opengis.kml.Change;
import net.opengis.kml.ColorMode;
import net.opengis.kml.Coordinate;
import net.opengis.kml.Create;
import net.opengis.kml.Data;
import net.opengis.kml.Delete;
import net.opengis.kml.DisplayMode;
import net.opengis.kml.Document;
import net.opengis.kml.ExtendedData;
import net.opengis.kml.Folder;
import net.opengis.kml.GridOrigin;
...
import net.opengis.kml.RefreshMode;
import net.opengis.kml.Region;
import net.opengis.kml.ResourceMap;
import net.opengis.kml.Scale;
import net.opengis.kml.Schema;
import net.opengis.kml.SchemaData;
import net.opengis.kml.ScreenOverlay;
import net.opengis.kml.Shape;
import net.opengis.kml.SimpleData;
import net.opengis.kml.SimpleField;
import net.opengis.kml.Snippet;
import net.opengis.kml.Style;
import net.opengis.kml.StyleMap;
import net.opengis.kml.StyleState;
import net.opengis.kml.TimeSpan;
import net.opengis.kml.TimeStamp;
import net.opengis.kml.Units;
import net.opengis.kml.Update;
import net.opengis.kml.Vec2;
import net.opengis.kml.ViewRefreshMode;
import net.opengis.kml.ViewVolume;
import net.opengis.kml.atom.Author;
import net.opengis.kml.xal.AddressDetails;
import net.opengis.kml.xal.AddressLine;
import net.opengis.kml.xal.AddressLines;
import net.opengis.kml.xal.AdministrativeArea;
import net.opengis.kml.xal.DependentLocality;
import net.opengis.kml.xal.Firm;
import net.opengis.kml.xal.LargeMailUser;
import net.opengis.kml.xal.Locality;
import net.opengis.kml.xal.PostBox;
import net.opengis.kml.xal.PostOffice;
import net.opengis.kml.xal.PostalCode;
import net.opengis.kml.xal.PostalRoute;
import net.opengis.kml.xal.Premise;
import net.opengis.kml.xal.PremiseNumber;
import net.opengis.kml.xal.Thoroughfare;
...
public final class KmlReferencePojoTest implements IKMLReference {
  ...
  @Override
	public void document() {
		...
		document.setAtomLink(new net.opengis.kml.atom.Link("..."));
		document.setAddress("...");
  ...
  @Override
	public void featureAscriptionElement() {
		...
		final net.opengis.kml.atom.Link link = new net.opengis.kml.atom.Link("http://www.harrypotter.com");
  ...
  @Override
	public void folder() {
		...
		final net.opengis.kml.atom.Link link = new net.opengis.kml.atom.Link("...");
  ...
  @Override
	public void networkLink() {
		...
		author.getNameOrUriOrEmail().add("...");
		final net.opengis.kml.atom.Link atomLink = new net.opengis.kml.atom.Link("...");
		atomLink.setHref("...");
  ...
  @Override
	public void photoOverlay() {
		...
		photooverlay.setAtomLink(new net.opengis.kml.atom.Link("..."));
  ...
  @Override
	public void placemark() {
		...
		placemark.setAtomLink(new net.opengis.kml.atom.Link(""));
  ...
  @Override
	public void screenOverlay() {
		...
		screenoverlay.setAtomLink(new net.opengis.kml.atom.Link(""));
