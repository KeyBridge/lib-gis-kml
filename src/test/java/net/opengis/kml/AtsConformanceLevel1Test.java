...
import net.opengis.kml.internal.IAtsConformanceLevel1;
...
import net.opengis.kml.gx.TourPrimitive;
...
public class AtsConformanceLevel1Test implements IAtsConformanceLevel1 {
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel1#atc02XMLSchemaconstraints()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel1#atc03GeometryCoordinates()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel1#atc07SharedStyleDefintion()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel1#atc08RegionLatLonAltBox()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel1#atc13GeometryTessellate()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel1#atc16LinearRingControlPoints()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel1#atc19ViewVolumeMinimalContent()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel1#atc20NetworkLinkControlMinRefreshPeriod()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel1#atc22UpdateTargetHref()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel1#atc23IdentificationOfUpdateTarget()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel1#atc26SchemaSimpleField()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel1#atc27ExtendedDataSchemaData()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel1#atc28ExtendedDataData()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel1#atc32OrientationMinimalContent()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel1#atc35PhotoOverlayMinimalContent()
   */
  @Test
  @Override
