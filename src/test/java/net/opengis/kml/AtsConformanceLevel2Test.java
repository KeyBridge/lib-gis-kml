...
public class AtsConformanceLevel2Test implements IAtsConformanceLevel2 {
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel2#atc43CoordinatesAltitudeMode()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel2#atc44ScaleMinimalContent()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel2#atc45KMLMinimalContent()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel2#atc48LinearRingInPolygon()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel2#atc50ResourceMapAlias()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel2#atc51LinkRefreshValues()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel2#atc53GroundOverlayMinimalContent()
   */
  @Test
  @Override
