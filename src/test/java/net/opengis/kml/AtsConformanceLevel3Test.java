...
import net.opengis.kml.internal.IAtsConformanceLevel3;
...
public class AtsConformanceLevel3Test implements IAtsConformanceLevel3 {
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel3#atc70LinearRingSimple()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel3#atc71BaloonStyleColor()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel3#atc73ScaleFullContent()
   */
  @Test
  @Override
  ...
  /**
   * @see
   * de.micromata.jak.internal.IAtsConformanceLevel3#atc75OrientationFullContent()
   */
  @Test
  @Override
