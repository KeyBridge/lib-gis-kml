...
public class Boundary implements Cloneable {
  ...
  public Boundary(LinearRing linearRing) {
  ...
  public List<Object> getBoundarySimpleExtension() {
    if (boundarySimpleExtension == null) {
      boundarySimpleExtension = new ArrayList<>();
    }
  ...
  public List<AbstractObject> getBoundaryObjectExtension() {
    if (boundaryObjectExtension == null) {
      boundaryObjectExtension = new ArrayList<>();
    }
  ...
  public boolean equals(Object obj) {
    ...
    } else if (linearRing.equals(other.linearRing) == false) {
      return false;
    }
    if (boundarySimpleExtension == null) {
    ...
    } else if (boundarySimpleExtension.equals(other.boundarySimpleExtension) == false) {
      return false;
    }
    if (boundaryObjectExtension == null) {
    ...
    } else if (boundaryObjectExtension.equals(other.boundaryObjectExtension) == false) {
      return false;
    }
    return true;
  }
  ...
  public Boundary clone() {
    ...
    copy.boundarySimpleExtension = new ArrayList<>((getBoundarySimpleExtension().size()));
    for (Object iter : boundarySimpleExtension) {
      copy.boundarySimpleExtension.add(iter);
    }
    copy.boundaryObjectExtension = new ArrayList<>((getBoundaryObjectExtension().size()));
