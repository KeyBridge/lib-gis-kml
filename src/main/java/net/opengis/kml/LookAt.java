 ...
 * Feature. The LookAt element positions the "camera" in relation to the object
 * that is being viewed. In Google Earth, the view "flies to" this LookAt
 * viewpoint when the user double-clicks an item in the Places panel or
 * double-clicks an icon in the 3D viewer. Syntax: &lt;pre&gt;
 * &lt;strong&gt;&lt;LookAt id="ID"&gt; &lt;/strong&gt; &lt;!-- inherited from
 * AbstractView element --&gt;
 * &lt;em&gt;&lt;TimePrimitive&gt;...&lt;/TimePrimitive&gt; &lt;/em&gt; &lt;!--
 * gx:TimeSpan or gx:TimeStamp --&gt;
 * <p>
 * &lt;!-- specific to LookAt --&gt; &lt;longitude&gt;0&lt;/longitude&gt;
...
public class LookAt
  ...
  public List<Object> getLookAtSimpleExtension() {
    if (lookAtSimpleExtension == null) {
      lookAtSimpleExtension = new ArrayList<>();
    }
  ...
  public List<AbstractObject> getLookAtObjectExtension() {
    if (lookAtObjectExtension == null) {
      lookAtObjectExtension = new ArrayList<>();
    }
  ...
  public boolean equals(Object obj) {
    ...
    } else if (lookAtSimpleExtension.equals(other.lookAtSimpleExtension) == false) {
      return false;
    }
    if (lookAtObjectExtension == null) {
    ...
    } else if (lookAtObjectExtension.equals(other.lookAtObjectExtension) == false) {
      return false;
    }
    return true;
  }
  ...
  public LookAt clone() {
    ...
    copy.lookAtSimpleExtension = new ArrayList<>((getLookAtSimpleExtension().size()));
    for (Object iter : lookAtSimpleExtension) {
      copy.lookAtSimpleExtension.add(iter);
    }
    copy.lookAtObjectExtension = new ArrayList<>((getLookAtObjectExtension().size()));
