...
public class ResourceMap
  ...
  public List<Object> getResourceMapSimpleExtension() {
    if (resourceMapSimpleExtension == null) {
      resourceMapSimpleExtension = new ArrayList<>();
    }
  ...
  public List<AbstractObject> getResourceMapObjectExtension() {
    if (resourceMapObjectExtension == null) {
      resourceMapObjectExtension = new ArrayList<>();
    }
  ...
  public boolean equals(Object obj) {
    ...
    } else if (alias.equals(other.alias) == false) {
      return false;
    }
    if (resourceMapSimpleExtension == null) {
    ...
    } else if (resourceMapSimpleExtension.equals(other.resourceMapSimpleExtension) == false) {
      return false;
    }
    if (resourceMapObjectExtension == null) {
    ...
    } else if (resourceMapObjectExtension.equals(other.resourceMapObjectExtension) == false) {
      return false;
    }
    return true;
  }
  ...
  public ResourceMap clone() {
    ...
    copy.alias = new ArrayList<>((getAlias().size()));
    for (Alias iter : alias) {
      copy.alias.add(iter.clone());
    }
    copy.resourceMapSimpleExtension = new ArrayList<>((getResourceMapSimpleExtension().size()));
    for (Object iter : resourceMapSimpleExtension) {
      copy.resourceMapSimpleExtension.add(iter);
    }
    copy.resourceMapObjectExtension = new ArrayList<>((getResourceMapObjectExtension().size()));
