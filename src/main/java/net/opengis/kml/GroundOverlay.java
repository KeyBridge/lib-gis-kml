 ...
 * of
 * <Icon> specifies the image to be used as the overlay. This file can be either
...
public class GroundOverlay
   ...
   * for the ground overlay are aligned. <north> Specifies the latitude of the
   * north edge of the bounding box, in decimal degrees from 0 to ±90. <south>
   * Specifies the latitude of the south edge of the bounding box, in decimal
   * degrees from 0 to ±90. <east>
   ...
   * longitude of the west edge of the bounding box, in decimal degrees from 0
   * to ±180. (For overlays that overlap the meridian of 180° longitude, values
   * can extend beyond that range.) <rotation>
   ...
   * <south>48.25207367852141</south> <east>-90.86591508839973</east>
   ...
   *                                     allowed in the list:
   *                                     {@code <}{@link LatLonQuad}{@code>}{@link JAXBElement}{@code <}{@link AbstractObject}{@code>}
   * @return <tt>true</tt> (as general contract of <tt>Collection.add</tt>).
   */
