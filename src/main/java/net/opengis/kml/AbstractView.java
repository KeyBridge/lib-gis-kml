...
public abstract class AbstractView
  ...
  public List<Object> getAbstractViewSimpleExtension() {
    if (abstractViewSimpleExtension == null) {
      abstractViewSimpleExtension = new ArrayList<>();
    }
  ...
  public List<AbstractObject> getAbstractViewObjectExtension() {
    if (abstractViewObjectExtension == null) {
      abstractViewObjectExtension = new ArrayList<>();
    }
  ...
  public boolean equals(Object obj) {
    ...
    } else if (abstractViewSimpleExtension.equals(other.abstractViewSimpleExtension) == false) {
      return false;
    }
    if (abstractViewObjectExtension == null) {
    ...
    } else if (abstractViewObjectExtension.equals(other.abstractViewObjectExtension) == false) {
      return false;
    }
    return true;
  }
  ...
  public AbstractView clone() {
    ...
    copy.abstractViewSimpleExtension = new ArrayList<>((getAbstractViewSimpleExtension().size()));
    for (Object iter : abstractViewSimpleExtension) {
      copy.abstractViewSimpleExtension.add(iter);
    }
    copy.abstractViewObjectExtension = new ArrayList<>((getAbstractViewObjectExtension().size()));
