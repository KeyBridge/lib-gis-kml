...
public class BasicLink
  ...
  public List<Object> getBasicLinkSimpleExtension() {
    if (basicLinkSimpleExtension == null) {
      basicLinkSimpleExtension = new ArrayList<>();
    }
  ...
  public List<AbstractObject> getBasicLinkObjectExtension() {
    if (basicLinkObjectExtension == null) {
      basicLinkObjectExtension = new ArrayList<>();
    }
  ...
  public boolean equals(Object obj) {
    ...
    } else if (basicLinkSimpleExtension.equals(other.basicLinkSimpleExtension) == false) {
      return false;
    }
    if (basicLinkObjectExtension == null) {
    ...
    } else if (basicLinkObjectExtension.equals(other.basicLinkObjectExtension) == false) {
      return false;
    }
    return true;
  }
  ...
  public BasicLink clone() {
    ...
    copy.basicLinkSimpleExtension = new ArrayList<>((getBasicLinkSimpleExtension().size()));
    for (Object iter : basicLinkSimpleExtension) {
      copy.basicLinkSimpleExtension.add(iter);
    }
    copy.basicLinkObjectExtension = new ArrayList<>((getBasicLinkObjectExtension().size()));
