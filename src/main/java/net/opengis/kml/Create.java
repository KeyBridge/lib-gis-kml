 ...
 * </p>
 * <p>
 * Once an object has been created and loaded into Google Earth, it takes on the
 * URL of the original parent Document of Folder. To perform subsequent updates
 * to objects added with this Update/Create mechanism, set <targetHref> to the
 * URL of the original Document or Folder (not the URL of the file that loaded
 * the intervening updates).
 * </p>
 * <p>
 * <p>
 * <p>
...
public class Create implements Cloneable {
   ...
   *                  {@code <}{@link Container}{@code>}{@link JAXBElement}{@code <}{@link Folder}{@code>}{@link JAXBElement}{@code <}{@link Document}{@code>}
