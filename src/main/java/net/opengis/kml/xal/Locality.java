...
public class Locality implements Cloneable {
  ...
  public boolean equals(Object obj) {
    ...
    } else if (localityName.equals(other.localityName) == false) {
      return false;
    }
    if (postBox == null) {
  ...
  /**
   * Sets the value of the localityName property Objects of the following
   * type(s) are allowed in the list List &lt;LocalityName&gt;.
   * <p>
   * Note:
   * <p>
   * This method does not make use of the fluent pattern.If you would like to
  ...
  public Locality clone() {
    ...
    copy.localityName = new ArrayList<>((getLocalityName().size()));
