...
public class PostBox implements Cloneable {
  ...
  public boolean equals(Object obj) {
    ...
    } else if (postBoxNumber.equals(other.postBoxNumber) == false) {
      return false;
    }
    ...
    } else if (postBoxNumberPrefix.equals(other.postBoxNumberPrefix) == false) {
      return false;
    }
    ...
    } else if (postBoxNumberSuffix.equals(other.postBoxNumberSuffix) == false) {
      return false;
    }
    ...
    } else if (postBoxNumberExtension.equals(other.postBoxNumberExtension) == false) {
      return false;
    }
    if (firm == null) {
      if (other.firm != null) {
