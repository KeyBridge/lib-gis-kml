...
public class LargeMailUser implements Cloneable {
  ...
  public boolean equals(Object obj) {
    ...
    } else if (largeMailUserName.equals(other.largeMailUserName) == false) {
      return false;
    }
    ...
    } else if (largeMailUserIdentifier.equals(other.largeMailUserIdentifier) == false) {
      return false;
    }
    if (buildingName == null) {
    ...
    } else if (department.equals(other.department) == false) {
      return false;
    }
    if (postBox == null) {
  ...
  public LargeMailUser clone() {
    ...
    copy.largeMailUserName = new ArrayList<>((getLargeMailUserName().size()));
