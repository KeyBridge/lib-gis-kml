...
public class MailStop implements Cloneable {
  ...
  public boolean equals(Object obj) {
    ...
    } else if (mailStopName.equals(other.mailStopName) == false) {
      return false;
    }
    ...
    } else if (mailStopNumber.equals(other.mailStopNumber) == false) {
      return false;
    }
    if (any == null) {
      if (other.any != null) {
  ...
  public static class MailStopNumber implements Cloneable {
    ...
    public boolean equals(Object obj) {
      ...
      } else if (nameNumberSeparator.equals(other.nameNumberSeparator) == false) {
        return false;
      }
      if (code == null) {
        if (other.code != null) {
