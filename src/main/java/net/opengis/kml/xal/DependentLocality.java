...
public class DependentLocality implements Cloneable {
   ...
   *         {@code DependentLocality.DependentLocalityNumber}
   *
   */
  ...
  public boolean equals(Object obj) {
    ...
    } else if (dependentLocalityName.equals(other.dependentLocalityName) == false) {
      return false;
    }
    ...
    } else if (dependentLocalityNumber.equals(other.dependentLocalityNumber) == false) {
      return false;
    }
    if (postBox == null) {
    ...
    } else if (largeMailUser.equals(other.largeMailUser) == false) {
      return false;
    }
    if (postOffice == null) {
    ...
    } else if (postalRoute.equals(other.postalRoute) == false) {
      return false;
    }
    ...
    } else if (connector.equals(other.connector) == false) {
      return false;
    }
    if (indicator == null) {
  ...
  /**
   * Creates a new instance of {@code DependentLocality.DependentLocalityName}
   * and adds it to dependentLocalityName. This method is a short version for:
   * &lt;code&gt; DependentLocalityName dependentLocalityName = new
   * DependentLocalityName();
  ...
  /**
   * Creates a new instance of {@code DependentLocality.DependentLocalityNumber}
   * and set it to dependentLocalityNumber.
   * <p>
   * This method is a short version for: &lt;code&gt; DependentLocalityNumber
   * dependentLocalityNumber = new DependentLocalityNumber();
   ...
   * largeMailUser = new LargeMailUser(); this.setLargeMailUser(largeMailUser);
   * &lt;/code&gt;
   */
  ...
  /**
   * Sets the value of the dependentLocalityName property Objects of the
   ...
   * <p>
   * This method does not make use of the fluent pattern.If you would like to
   * make it fluent, use {@code #withDependentLocalityName} instead.
   *
   ...
   *
   * @param dependentLocalityName Objects of the following type are allowed in
   *                              the list:
   *                              {@code DependentLocality.DependentLocalityName}
   * @return &lt;tt&gt;true &lt;/tt&gt; (as general contract of
   *         &lt;tt&gt;Collection.add &lt;/tt&gt;).
   */
  ...
  public DependentLocality clone() {
    ...
    copy.dependentLocalityName = new ArrayList<>((getDependentLocalityName().size()));
  ...
  public static class DependentLocalityNumber implements Cloneable {
    ...
    public boolean equals(Object obj) {
      ...
      } else if (nameNumberOccurrence.equals(other.nameNumberOccurrence) == false) {
        return false;
      }
      if (code == null) {
        if (other.code != null) {
