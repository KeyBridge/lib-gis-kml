...
public class Premise implements Cloneable {
  ...
  public boolean equals(Object obj) {
    ...
    } else if (premiseName.equals(other.premiseName) == false) {
      return false;
    }
    ...
    } else if (premiseLocation.equals(other.premiseLocation) == false) {
      return false;
    }
    if (premiseNumber == null) {
    ...
    } else if (premiseNumber.equals(other.premiseNumber) == false) {
      return false;
    }
    ...
    } else if (premiseNumberRange.equals(other.premiseNumberRange) == false) {
      return false;
    }
    if (premiseNumberPrefix == null) {
    ...
    } else if (premiseNumberPrefix.equals(other.premiseNumberPrefix) == false) {
      return false;
    }
    if (premiseNumberSuffix == null) {
    ...
    } else if (premiseNumberSuffix.equals(other.premiseNumberSuffix) == false) {
      return false;
    }
    if (buildingName == null) {
    ...
    } else if (xalPremiseDependency.equals(other.xalPremiseDependency) == false) {
      return false;
    }
    ...
    } else if (premiseDependency.equals(other.premiseDependency) == false) {
      return false;
    }
    ...
    } else if (premiseThoroughfareConnector.equals(other.premiseThoroughfareConnector) == false) {
      return false;
    }
    return true;
  }
   ...
   * premiseName. This method is a short version for:    <code>
  ...
  /**
   * Sets the value of the premiseName property Objects of the following type(s)
   * are allowed in the list List<PremiseName>.
   * <p>
   * Note:
   * <p>
   * This method does not make use of the fluent pattern.If you would like to
  ...
  /**
   * Sets the value of the premiseNumber property Objects of the following
   * type(s) are allowed in the list List<PremiseNumber>.
   * <p>
   * Note:
   * <p>
   * This method does not make use of the fluent pattern.If you would like to
  ...
  /**
   * Sets the value of the premiseNumberPrefix property Objects of the following
   * type(s) are allowed in the list List<PremiseNumberPrefix>.
   * <p>
   * Note:
   * <p>
   * This method does not make use of the fluent pattern.If you would like to
  ...
  /**
   * Sets the value of the premiseNumberSuffix property Objects of the following
   * type(s) are allowed in the list List<PremiseNumberSuffix>.
   * <p>
   * Note:
   * <p>
   * This method does not make use of the fluent pattern.If you would like to
  ...
  /**
   * Sets the value of the subPremise property Objects of the following type(s)
   * are allowed in the list List<SubPremise>.
   * <p>
   * Note:
   * <p>
   * This method does not make use of the fluent pattern.If you would like to
  ...
  public static class PremiseNumberRange implements Cloneable {
    ...
    public boolean equals(Object obj) {
      ...
      } else if (premiseNumberRangeFrom.equals(other.premiseNumberRangeFrom) == false) {
        return false;
      }
      ...
      } else if (premiseNumberRangeTo.equals(other.premiseNumberRangeTo) == false) {
        return false;
      }
      if (range == null) {
        if (other.range != null) {
      ...
      } else if (indicatorOccurence.equals(other.indicatorOccurence) == false) {
        return false;
      }
      ...
      } else if (numberRangeOccurence.equals(other.numberRangeOccurence) == false) {
        return false;
      }
      return true;
    }
    ...
    public static class PremiseNumberRangeFrom implements Cloneable {
      ...
      /**
       * Sets the value of the premiseNumberPrefix property Objects of the
       * following type(s) are allowed in the list List<PremiseNumberPrefix>.
       * <p>
       * Note:
       * <p>
       * This method does not make use of the fluent pattern.If you would like
      ...
      /**
       * Sets the value of the premiseNumberSuffix property Objects of the
       * following type(s) are allowed in the list List<PremiseNumberSuffix>.
       * <p>
       * Note:
       * <p>
       * This method does not make use of the fluent pattern.If you would like
