...
public class PolyStyle
  ...
  public List<Object> getPolyStyleSimpleExtension() {
    if (polyStyleSimpleExtension == null) {
      polyStyleSimpleExtension = new ArrayList<>();
    }
  ...
  public List<AbstractObject> getPolyStyleObjectExtension() {
    if (polyStyleObjectExtension == null) {
      polyStyleObjectExtension = new ArrayList<>();
    }
  ...
  public boolean equals(Object obj) {
    ...
    } else if (fill.equals(other.fill) == false) {
      return false;
    }
    if (outline == null) {
    ...
    } else if (outline.equals(other.outline) == false) {
      return false;
    }
    if (polyStyleSimpleExtension == null) {
    ...
    } else if (polyStyleSimpleExtension.equals(other.polyStyleSimpleExtension) == false) {
      return false;
    }
    if (polyStyleObjectExtension == null) {
    ...
    } else if (polyStyleObjectExtension.equals(other.polyStyleObjectExtension) == false) {
      return false;
    }
    return true;
  }
  ...
  public PolyStyle clone() {
    ...
    copy.polyStyleSimpleExtension = new ArrayList<>((getPolyStyleSimpleExtension().size()));
    for (Object iter : polyStyleSimpleExtension) {
      copy.polyStyleSimpleExtension.add(iter);
    }
    copy.polyStyleObjectExtension = new ArrayList<>((getPolyStyleObjectExtension().size()));
